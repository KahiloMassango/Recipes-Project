...
class Recipe(models.Model):
    ...
    preparation_time_unit = models.CharField(max_length=65, choices=Prep_unit_choices, default="Minuto/s")  # noqa: E501
    # servings servings_unit
    servings = models.IntegerField()
    servings_unit = models.CharField(max_length=65,  choices=Servings_unit_choices, default="Prato/s")  # noqa: E501
    # preparation_step
